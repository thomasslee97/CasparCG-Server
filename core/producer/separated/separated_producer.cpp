...
class separated_producer : public frame_producer_base
{
  ...
  public:
    ...
    draw_frame receive_impl() override
    {
        ...
        if (fill_ == core::draw_frame::late() ||
            key_ == core::draw_frame::late()) // One of the producers is lagging, keep them in sync.
    ...
    constraints& pixel_constraints() override { return fill_producer_->pixel_constraints(); }
    ...
    bool                  has_timecode() const override { return fill_producer_->has_timecode(); }
};
