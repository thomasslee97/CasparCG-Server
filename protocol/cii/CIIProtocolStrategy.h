...
public:
	...
	core::frame_producer_dependencies get_dependencies() const { return core::frame_producer_dependencies(GetChannel()->frame_factory(), channels_, format_repository_, GetChannel()->video_format_desc(), producer_registry_, cg_registry_); }
